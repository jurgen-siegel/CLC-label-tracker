...
# Create a new MongoDB collection for user data
...
# Streamlit login and registration pages
st.title('User Login and Registration')

page = st.radio("Pages", ["Login", "Register"])
...
if page == "Register":
    ...
    if st.button('Login'):
        ...
        if user and verify_password(password, user['password']):
            ...
            # Implement session management here to keep track of the logged-in user
        else:
